...
Feature: Lista de Espera
  ...
  Scenario: CP_HU001_01 — Registro exitoso en lista de espera y visualización de confirmación
    ...
    And la sección "Platea Central" no tiene asientos disponibles
    And no tengo una suscripción activa previa para esa sección y evento
    When intento interactuar con la sección "Platea Central"
    ...
    Then el sistema debe registrar mi suscripción en la base de datos asociándola a mi usuario, al evento "Concierto Sinfónico" y a la sección "Platea Central"
  ...
  Scenario: CP_HU001_03 — Impedir registro duplicado en la misma lista de espera
    Given accedo a la página de detalles del evento "Concierto Sinfónico"
    And la sección "Platea Central" no tiene asientos disponibles
    And ya me encuentro registrado en la lista de espera para la sección "Platea Central" del evento "Concierto Sinfónico"
